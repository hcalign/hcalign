...
MODEL_PATH='weights/msrvtt_9k_fineturn_vit32.pth'
# MODEL_PATH='weights/webvid1m-pretrain-vit32.pth'
# MODEL_PATH='weights/webvid2m-pretrain-vit32.pth'
...
python -m torch.distributed.launch --nproc_per_node=4 --master_port 53 \
    main_hcalign.py  --num_thread_reader=8 --do_eval  \
    ...
    --cc_msl_weight 0.5 --cc_start_epoch 1 --cc_selection_thresh 0.5 --cc_num_prototypes 3000
